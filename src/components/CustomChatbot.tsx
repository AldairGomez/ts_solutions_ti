                  ...
                  {msg.textKey === 'fallbackMessage' || hasContactCards ? (
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex flex-col gap-2">
                        <a href="https://wa.me/51968094072" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-lg hover:bg-[#20b858] transition-colors font-bold self-start shadow-sm select-none">
                        ...
                        <button type="button" onClick={handleCopyEmail} className="inline-flex items-center justify-center gap-2 bg-[#1b61f2] text-white px-4 py-2 rounded-lg hover:bg-[#1448b8] transition-colors font-bold self-start shadow-sm select-none">
